...
void Image::getPixel(double x, double y, unsigned char *pixel) { getPixel(x, y, pixel, nullptr); }
...
void Image::computeShift(unsigned long mask, unsigned char &left_shift, unsigned char &right_shift)
{
	left_shift = 0;
	right_shift = 8;
